...
class UserPlanController extends Controller
{
    ...
    public function listing(Request $request)
    {
        ...
        foreach ($user_plans as $user_plan) {
            ...
            $records['data'][] = [
                'id' => $user_plan->id ?? '',
                'user_id' =>  $user_plan->user ? "{$user_plan->user->full_name} ({$user_plan->user->email})"  : 'N/A',
                ...
                'device_type' => $user_plan->device ? $user_plan->device->device_type : 'N/A',
                'purchase_at' => $user_plan->purchase_at ? Carbon::parse($user_plan->purchase_at)->format('d M Y') : 'N/A',
                'expiry_at' => $user_plan->expiry_at ? Carbon::parse($user_plan->expiry_at)->format('d M Y') : 'N/A',
